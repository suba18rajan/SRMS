...
class Courseclass:
    def __init__(self, root):
        ...
        lbl_duration = Label(
            self.root, text="Duration", font=("goudy old style", 15, "bold"), bg="white"
        ).place(x=10, y=100)
        lbl_charges = Label(
            self.root, text="Charges", font=("goudy old style", 15, "bold"), bg="white"
        ).place(x=10, y=140)
        ...
        try:
            if self.var_course.get() == "":
                ...
                if row == None:
                    messagebox.showerror(
                        "Error",
                        "Please Select the Course From the List First",
                        parent=self.root,
                    )
                else:
